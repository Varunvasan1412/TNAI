...
import { LiveTime } from '../ui';
import ChatNotificationBell from '../ui/ChatNotificationBell';
...
const Header = ({ toggleSidebar, isSidebarOpen }) => {
  ...
  const userRole = authUser.role || authUser.user_type || 'Admin';
    ...
    >
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Desktop Search (Commented out as per request) */}
        ...
        <div className="flex items-center gap-1">
          ...
          {/* Mobile Search (Commented out as per request) */}
          {/* <HeaderDropdown
            align="right"
            width="w-72"
            className="lg:hidden"
            ...
            {(close) => (
              <div className="p-1.5 space-y-0.5">
                ...
                <Link
                  to="/auth-lock-screen"
                  onClick={close}
                  className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-primary/10 hover:text-primary dark:hover:bg-emerald-900/20 dark:hover:text-emerald-400 rounded-lg transition-colors"
                >
                ...
                <Link
                  to="/auth-logout"
                  onClick={close}
                  className="flex items-center gap-3 px-3 py-2 text-sm font-bold text-danger hover:bg-danger/10 rounded-lg transition-colors"
                >
