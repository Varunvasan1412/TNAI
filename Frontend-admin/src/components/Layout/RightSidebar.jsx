...
/**
 * Reusable radio group for theme settings.
 */
      ...
      {options.map((opt) => (
        ...
        >
          <input
            ...
            className={cn(
              'w-4 h-4 border-gray-300 dark:border-slate-600',
              'text-primary focus:ring-2 focus:ring-primary/50 focus:ring-offset-0',
                  ...
                  <>
                    <SettingRadioGroup
                      ...
                      options={[
                        ...
                        { label: 'Compact', value: 'md' },
                        { label: 'Small (Icon View)', value: 'sm' },
                      ]}
                    />
