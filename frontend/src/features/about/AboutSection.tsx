...
const aboutOneImg1 = 'https://images.unsplash.com/photo-1582560475093-ba66accbc424?w=600&h=700&fit=crop&crop=center&q=90';
// Close-up of lab glassware / research setup
const aboutOneImg2 = 'https://images.unsplash.com/photo-1617155093730-a8bf47be792d?w=400&h=400&fit=crop&crop=center&q=90';
...
const pointsData: PointItem[] = [
    {
        ...
        text: 'We design and manufacture custom electrochemical fixtures and research systems based on customer requirements.',
    },
    {
        id: 2,
        iconClass: 'icon-happy-customer',
        title: 'Expert Technical Support',
        text: 'Dedicated support team to help academic institutions, R&D labs, and startups get the most from their equipment.',
    },
];

const checkItems: CheckItem[] = [
    { id: 1, text: 'Electrochemical research accessories & battery materials.' },
    { id: 2, text: 'Hydrogen generation & electrolyser systems.' },
    { id: 3, text: 'PEM / AEM fuel cell fixtures & custom electrochemical setups.' },
];
...
const AboutSection: React.FC<SecProp> = ({ secClass = "" }) => {
                            ...
                            <div className="about-one__img-box">
                                ...
                                <div className="about-one__experience-box">
                                    ...
                                    <p className="about-one__experience-text">
                                        Years in Electrochemical Research
                                    </p>
                                </div>
